...
function getDefaultServerConfig() {
  return [
    ...
    'log-file=webui.log',
    '# Set to true to skip automatic system proxy detection for Node/Copilot.',
...
function getRunWebUISh() {
  return [
    ...
    '  --skip-system-proxy         Do not auto-configure Node/Copilot proxy environment',
    ...
    '    skip-system-proxy|skipSystemProxy) SKIP_SYSTEM_PROXY=$2 ;;',
    '  esac',
    '}',
    '',
    'load_config() {',
    ...
    '    --skip-system-proxy) CLI_SKIP_SYSTEM_PROXY=true; shift ;;',
    '    -h|--help) usage; exit 0 ;;',
    ...
    '[ -n "$CLI_SKIP_SYSTEM_PROXY" ] && SKIP_SYSTEM_PROXY=$CLI_SKIP_SYSTEM_PROXY',
    '',
    'HOST=${HOST:-127.0.0.1}',
    'PORT=${PORT:-8080}',
    '',
    'if is_truthy "$SKIP_SYSTEM_PROXY"; then',
    '  echo "Skipping system proxy auto-configuration for Node/Copilot."',
    'else',
    '  initialize_proxy_environment',
    'fi',
    'ensure_node',
...
function getRunWebUIPowerShell() {
  return [
    ...
    '$skipSystemProxyValue = Get-ConfigValue $configValues @("skip-system-proxy", "skipSystemProxy") "false"',
    '',
    ...
    'if ($PSBoundParameters.ContainsKey("SkipSystemProxy")) { $skipSystemProxyValue = "true" }',
    '',
    'if (Test-Truthy $skipSystemProxyValue) {',
    '  Write-Host "Skipping system proxy auto-configuration for Node/Copilot."',
    '} else {',
