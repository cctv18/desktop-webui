...
function getRunWebUIPowerShell() {
  return [
    ...
    '  }',
    '  Write-Host "[$((Get-Date).ToString(\'yyyy-MM-dd HH:mm:ss.ffffff\'))] Appending GitDesk WebUI logs to $logFileValue"',
    '  & $nodeCommand.Source @script:NodeArguments 2>&1 | Tee-Object -FilePath $logFileValue -Append',
    '  exit $LASTEXITCODE',
    '}',
