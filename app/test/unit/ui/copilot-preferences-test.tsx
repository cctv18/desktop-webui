...
function defaults() {
  return {
    ...
    copilotOAuthStatus: { kind: 'unauthorized' as const },
    byokProviders: [],
    showBYOKSettings: false,
    onSelectedCopilotModelChanged: () => {},
    onBeginCopilotOAuthDeviceFlow: async () => ({
    ...
    onPollCopilotOAuthDeviceFlow: async () => ({ kind: 'pending' as const }),
    onFetchCopilotModels: async () => {},
    onAddBYOKProvider: () => {},
    onEditBYOKProvider: () => {},
