...
> {
  ...
  private clearCommitMessage() {
    this.setCommitMessage(DefaultCommitMessage)
  }
  ...
  private setCommitMessage(commitMessage: ICommitMessage) {
    this.setState({ commitMessage }, () => {
      this.props.onPersistCommitMessage?.(this.state.commitMessage)
    })
  }
